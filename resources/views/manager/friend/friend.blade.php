                    ...
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="form-control" style="width:100px"
                                       onchange="ajaxData('/common/ajaxEditField',{'_token':'{{csrf_token()}}','table':'friend_link','field':'sort','value':this.value,'id':{{$val->id}}})" value="{{$val->sort}}"></td>
                            <td>{{$val->created_at}}</td>
                            <td>{{$val->updated_at}}</td>
                            <td>
                                <a href="/friend/curdFriend?id={{$val->id}}" title="修改" style="color: #0a0a0a">
                                    <i class="fa  fa-edit"></i>
                                </a>
                                <a href="/friend/delFriend?id={{$val->id}}&status=9" title="删除" style="color: #0a0a0a">
